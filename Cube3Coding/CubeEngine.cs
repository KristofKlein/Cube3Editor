        ...
        : IBlockCipher
    {
        ...
        */
            ...
            ICipherParameters parameters)
        {
            if (!(parameters is KeyParameter))
                throw new ArgumentException("invalid parameter passed to Blowfish init");
            ...
            int outOff)
        {
            ...
            DataLength(input, inOff, BLOCK_SIZE, "input buffer too short");
            OutputLength(output, outOff, BLOCK_SIZE, "output buffer too short");
        ...
        */
            ...
            int dstIndex)
        {
            ...
            xl = LE_To_UInt32(src, srcIndex);
            xr = LE_To_UInt32(src, srcIndex + 4);
