...
{
    internal static class CubeExtractorProgram
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (cube3File == null ||
                cube3File.Equals("-help", StringComparison.OrdinalIgnoreCase) ||
                cube3File.Equals("-?", StringComparison.OrdinalIgnoreCase) )
            {
                DisplayHelp();
                Environment.Exit(0);
            }
        ...
        private static void ExtractCubeFile()
        {
